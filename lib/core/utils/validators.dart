...
import 'package:tivi_tea/core/config/extensions/validator_extensions.dart';
...
class Validators {
  ...
  static Validator amount(num balance) {
    return (value) {
      if (value?.isEmpty == true) {
        return "This field can not be empty.";
      }
      if (num.parse(value!.removeCommas()) > balance) {
        return 'Amount is bigger than available balance';
      }
      return null;
    };
  }
