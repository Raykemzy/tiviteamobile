...
class _RestClient implements RestClient {
  ...
  Future<BaseResponse<ServiceProviderSignUpResponse>> signUpAsServiceProvider(
    ...
    final _options =
        _setStreamType<BaseResponse<ServiceProviderSignUpResponse>>(
  ...
  Future<BaseResponse<ServiceProviderSignUpResponse>> signUpAsArtisan(
    ...
    final _options =
      ...
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/authentication/artisan/sign-up',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
  ...
  Future<BaseResponse<CustomerSignUpResponseBody>> signUpAsCustomer(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(data.toJson());
    final _options = _setStreamType<BaseResponse<CustomerSignUpResponseBody>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<BaseResponse<LoginResponseObject>> login(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(data.toJson());
    final _options = _setStreamType<BaseResponse<LoginResponseObject>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<BaseResponse<dynamic>> submitArtisanKyc(
    ClientKYCRequestBody data,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<BaseResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/authentication/artisan/submit-kyc',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseResponse<SocialAuthResponse>> signUpWithSocialAuth(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(data.toJson());
    final _options = _setStreamType<BaseResponse<SocialAuthResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<BaseResponse<GenericPaginatedResponse<ListingResponseModel>>>
    ...
    final _options = _setStreamType<
        BaseResponse<GenericPaginatedResponse<ListingResponseModel>>>(
  ...
  @override
  Future<BaseResponse<dynamic>> deleteListing(String listingId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<BaseResponse<CreateFootSoldierResponse>> createFootSoldier(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(data.toJson());
    final _options = _setStreamType<BaseResponse<CreateFootSoldierResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<BaseResponse<ListBanksResponse>> getBanks() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<ListBanksResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment/banks/list',
  ...
  Future<BaseResponse<CreateTransferRecipientResponse>> createTransferRecipient(
    CreateTransferRecipientModel data,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    _data.addAll(data.toJson());
    final _options =
        _setStreamType<BaseResponse<CreateTransferRecipientResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<BaseResponse<GenericPaginatedResponse<CategoryResponseModel>>>
    ...
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<
        BaseResponse<GenericPaginatedResponse<CategoryResponseModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/listings/categories',
  ...
  @override
  Future<BaseResponse<GenericPaginatedResponse<ListingResponseModel>>>
      getMarketPlaceItems(int page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<BaseResponse<GenericPaginatedResponse<OwnerMarketplaceItemModel>>>
      getOwnersMarketPlaceItems(int page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<
        BaseResponse<GenericPaginatedResponse<OwnerMarketplaceItemModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/listings/market-place/owners-items',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<GenericPaginatedResponse<OwnerMarketplaceItemModel>>
        _value;
    try {
      _value = BaseResponse<
          GenericPaginatedResponse<OwnerMarketplaceItemModel>>.fromJson(
        _result.data!,
        (json) => GenericPaginatedResponse<OwnerMarketplaceItemModel>.fromJson(
          json as Map<String, dynamic>,
          (json) => OwnerMarketplaceItemModel.fromJson(
            json as Map<String, dynamic>,
          ),
        ),
      );
  ...
  Future<BaseResponse<dynamic>> createMarketplaceItem(
    ...
    final _options = _setStreamType<BaseResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/listings/market-place/item/create',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<dynamic> deleteMarketplaceItem(String itemId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<BaseResponse<GenericPaginatedResponse<NotificationModel>>>
    ...
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<
        BaseResponse<GenericPaginatedResponse<NotificationModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/notifications/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<GenericPaginatedResponse<NotificationModel>> _value;
    try {
      _value =
          BaseResponse<GenericPaginatedResponse<NotificationModel>>.fromJson(
        _result.data!,
        (json) => GenericPaginatedResponse<NotificationModel>.fromJson(
          json as Map<String, dynamic>,
  ...
  @override
  Future<BaseResponse<dynamic>> markAllNotificationsAsRead() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<BaseResponse<BookWorkSpaceResponse>> bookWorkspace(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(data.toJson());
    final _options = _setStreamType<BaseResponse<BookWorkSpaceResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<BaseResponse<GenericPaginatedResponse<BookingHistoryModel>>>
    ...
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<
        BaseResponse<GenericPaginatedResponse<BookingHistoryModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/bookings/list',
  ...
  @override
  Future<BaseResponse<dynamic>> checkInCheckOut({
    ...
    final _options = _setStreamType<BaseResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/bookings/${bookingId}/check-in-or-out',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseResponse<BookingHistoryModel>> getSingleBookingDetails({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<BookingHistoryModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/bookings/${bookingId}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<BookingHistoryModel> _value;
    try {
      _value = BaseResponse<BookingHistoryModel>.fromJson(
        _result.data!,
        (json) => BookingHistoryModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<BaseResponse<ServiceProviderDashboardModel>>
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<BaseResponse<ServiceProviderDashboardModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/dashboard/partner',
  ...
  Future<BaseResponse<ClientDashboardModel>> getClientDashboard() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<ClientDashboardModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/dashboard/client',
  ...
  Future<BaseResponse<GetUserProfileResponse>> getUserProfile() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<GetUserProfileResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<BaseResponse<dynamic>> favoriteListing(
    FavoriteListingRequestBody data,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<BaseResponse<GenericPaginatedResponse<FavoriteListingModel>>>
    ...
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<
        BaseResponse<GenericPaginatedResponse<FavoriteListingModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/dashboard/client/listing/favorite',
  ...
  Future<UploadProfilePicResponse> uploadProfilePic({
    ...
    final _options = _setStreamType<UploadProfilePicResponse>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
  ...
  Future<BaseResponse<PaymentCallbackResponse>> getPaymentStatus({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<PaymentCallbackResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/bookings/',
  ...
  Future<BaseResponse<WalletDetailsModel>> getWalletDetails() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<WalletDetailsModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment/wallet',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<WalletDetailsModel> _value;
    try {
      _value = BaseResponse<WalletDetailsModel>.fromJson(
        _result.data!,
        (json) => WalletDetailsModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<BaseResponse<dynamic>> createTransactionPin(
    UpdatePinModel data,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<BaseResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment/create-transaction-pin',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<BaseResponse<dynamic>> withdrawFromWallet(
    WithdrawFromWalletModel data,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse<dynamic>> contactUs(Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
