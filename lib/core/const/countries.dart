class Country {
  ...
  String get flagIconPath {
    switch (code) {
      case 'DO':
        return 'assets/icons/flags/DOX.svg';
      case 'IN':
        return 'assets/icons/flags/INX.svg';
      case 'IS':
        return 'assets/icons/flags/ISX.svg';
      default:
...
const List<Country> countries = [
  ...
  Country(name: 'Congo (Democratic Republic)', code: 'CD', dialCode: '+243'),
  ...
  Country(name: 'East Timor', code: 'TL', dialCode: '+670'),
  ...
  Country(name: 'Korea (North)', code: 'KP', dialCode: '+850'),
  Country(name: 'Korea (South)', code: 'KR', dialCode: '+82'),
  ...
  Country(name: 'Saint Vincent and the Grenadines', code: 'VC', dialCode: '+1-784'),
