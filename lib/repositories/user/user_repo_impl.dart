...
class UserRepoImpl implements UserRepository {
  ...
  Future<void> clearUserSession() async {
    // Clear user session data but preserve Apple and Google auth data
    ...
    // Note: We intentionally preserve Apple and Google auth data (appleFirstName, appleLastName, appleEmail, googleFirstName, googleLastName, googleEmail)
  }
  ...
  @override
  Future<void> clearGoogleAuthData() async {
    // Clear only Google auth data
    await _storage.delete(HiveKeys.googleFirstName);
    await _storage.delete(HiveKeys.googleLastName);
    await _storage.delete(HiveKeys.googleEmail);
  }
}
